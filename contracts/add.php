...
$date = date('d/m/Y');
try {
$query = "INSERT INTO tbl_infp SET name=?, description=?, valuel=?, endl=?, signature=? , created_at='$date'";
...
<title>Add Contracts | MyW3schools.com | Download Fiction, Health, Romance and many more ebooks for Free: any where, anytime!
</title> 
...
<input type="text" class="form-control" id="email21" name="name" placeholder="Customer Name *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" required> 
</div> 

<div class="form-field"> 
<input type="text" class="form-control" id="email22" name="description" placeholder="Description *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" required> 
</div> 

<div class="form-field"> 
<input type="text" class="form-control" id="email22" name="valuel" placeholder="Contract Value *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" required> 
</div> 
...
<div class="form-field"> 
<input type="date" class="form-control" id="email23" name="endl" placeholder="End Date *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="color:#999;" required> 
</div> 

<div class="form-field"> 
<select class="form-control" id="email24" name="signature" style="color:#999;" required> 
