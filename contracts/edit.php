...
if(isset($_POST['submit_btn'])) {
        ...
        $query = "UPDATE tbl_infp SET name=?, description=?, valuel=?, endl=?, signature=?  WHERE id=?";
        ...
        $stmt->bindParam(2, $_POST['description']);
		 ...
		 $stmt->bindParam(3, $_POST['valuel']);

		 $stmt->bindParam(4, $_POST['endl']);

        $stmt->bindParam(5, $_POST['signature']);
...
$query = "SELECT * FROM tbl_infp WHERE id=?";
...
<title>Edit Contracts | MyW3schools.com | Download Fiction, Health, Romance and many more ebooks for Free: any where, anytime!
</title> 
...
<input type="text" class="form-control" id="email21" name="name" value="<?php echo $name; ?>" placeholder="Customer Name *" autocomplete="off" style="color:#999;" autocorrect="off" autocapitalize="off" spellcheck="false" required> 
</div> 

<div class="form-field"> 
<input type="text" class="form-control" id="email22" name="description" value="<?php echo $description; ?>" placeholder="Description *" autocomplete="off" style="color:#999;" autocorrect="off" autocapitalize="off" spellcheck="false" required> 
</div> 

<div class="form-field"> 
<input type="text" class="form-control" id="email22" name="valuel" value="<?php echo $valuel; ?>" placeholder="Contract Value *" autocomplete="off" style="color:#999;" autocorrect="off" autocapitalize="off" spellcheck="false" required> 
</div> 
...
<div class="form-field"> 
<input type="date" class="form-control" id="email23" name="endl" value="<?php echo $endl; ?>" placeholder="End Date *" autocomplete="off" style="color:#999;" autocorrect="off" autocapitalize="off" spellcheck="false" required> 
</div> </br> 
...
<div class="panel-heading" id="item-12" role="tab" style="background-color:#eef1f4;"> <h5 class="panel-title" style="text-align: left;font-size:12px;"><a aria-controls="content-item-12" aria-expanded="true" data-parent="#accordion-1" data-toggle="collapse" href="#content-item-12" role="button"> <?php echo $signature; ?> </a></h5>
</div> 
...
<select class="form-control" id="email24" name="signature" value="<?php echo $signature; ?>" style="color:#999;" required> 
