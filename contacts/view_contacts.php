...
<title>View Contacts| MyW3schools.com | Download Fiction, Health, Romance and many more ebooks for Free: any where, anytime!
</title> 
...
<form action="#" method="post" action="process_form.php" name="qikenq_side" id="qikenq"> 

<div class="form-field"> 
<input type="text" class="form-control" id="email21" name="first_name" value="<?php echo $results[0]["first_name"] ?>" placeholder=" First Name *" autocomplete="off" style="color:#999;" required readonly> 
</div> 

<div class="form-field"> 
<input type="text" class="form-control" id="email22" name="middle_name" value="<?php echo $results[0]["middle_name"] ?>" placeholder="Middle Name *" autocomplete="off" style="color:#999;" required readonly> 
</div> 

<div class="form-field"> 
<input type="text" class="form-control" id="email23" name="last_name" value="<?php echo $results[0]["last_name"] ?>" placeholder="Last Name *" autocomplete="off" style="color:#999;" required readonly> 
</div> 

<div class="form-field"> 
<input type="email" class="form-control" id="email24" name="email_id" value="<?php echo $results[0]["email_address"] ?>" placeholder="Email *" autocomplete="off" style="color:#999;" required readonly> 
</div> 

<div class="form-field"> 
<input type="text" class="form-control" id="email25" name="contact_no1" value="<?php echo $results[0]["contact_no1"] ?>" placeholder="Phone Number #1 *" autocomplete="off" style="color:#999;" required readonly> 
</div> 

<div class="form-field"> 
<input type="text" class="form-control" id="email26" name="contact_no2" value="<?php echo $results[0]["contact_no2"] ?>" placeholder="Phone Number #2 *" autocomplete="off" style="color:#999;" required readonly> 
</div> 

<div class="form-field"> 
<textarea class="form-control" id="email27" rows="2" name="address" placeholder="Address *" autocomplete="off" style="color:#999;" required readonly> <?php echo $results[0]["address"] ?> 
</textarea> 
</div> </br> 
</form> 
</div> 
...
</body> </br> <center> <img src="../img/rsb.png" alt="myw3schools.com"> </center> </br> </br> </br> 
</div> 
</div> 
</div> 
</div> 
