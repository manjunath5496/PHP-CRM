...
<title> <?php if($_GET[cid] == true && $_GET[update] == false) { echo "Edit Contacts"; } else { echo "Add Contacts";} ?> | MyW3schools.com 
</title> 
...
<form class="form-horizontal" name="contact_form" id="qikenq" enctype="multipart/form-data" method="post" action="process_form.php">

<input type="hidden" name="mode" value="<?php echo ($_GET["m"] == "update") ? "update_old" : "add_new"; ?>" ><input type="hidden" name="old_pic" value="<?php echo $results[0]["profile_pic"] ?>" ><input type="hidden" name="cid" value="<?php echo intval($results[0]["contact_id"]); ?>" ><input type="hidden" name="pagenum" value="<?php echo $_GET["pagenum"]; ?>" ><div class="form-field"><input type="text" value="<?php echo $results[0]["first_name"] ?>" placeholder="First Name *" autocomplete="off" id="email21" class="form-control" name="first_name" autocorrect="off" autocapitalize="off" spellcheck="false" style ="color:#999;" required> </div> <div class="form-field"><input type="text" value="<?php echo $results[0]["middle_name"] ?>" placeholder="Middle Name *" autocomplete="off" id="email22" class="form-control" name="middle_name" autocorrect="off" autocapitalize="off" spellcheck="false" style ="color:#999;" required> </div> <div class="form-field"> <input type="text" value="<?php echo $results[0]["last_name"] ?>" placeholder="Last Name *" autocomplete="off" id="email23" class="form-control" name="last_name" autocorrect="off" autocapitalize="off" spellcheck="false" style ="color:#999;" required> </div> <div class="form-field"> <input type="text" value="<?php echo $results[0]["email_address"] ?>" placeholder="Email *" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"  autocomplete="off" id="email24" class="form-control" name="email_id" autocorrect="off" autocapitalize="off" spellcheck="false" style ="color:#999;" required> </div><div class="form-field"><input type="text" value="<?php echo $results[0]["contact_no1"] ?>" placeholder="Phone Number #1 *" autocomplete="off" id="email25" class="form-control" name="contact_no1" autocorrect="off" autocapitalize="off" spellcheck="false" style ="color:#999;" required> </div><div class="form-field"><input type="text" value="<?php echo $results[0]["contact_no2"] ?>" placeholder="Phone Number #2 *" autocomplete="off" id="email26" class="form-control" name="contact_no2" autocorrect="off" autocapitalize="off" spellcheck="false" style ="color:#999;" required></div> <div class="form-field"> <textarea id="email27" name="address" rows="3" class="form-control" placeholder="Address *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" style ="color:#999;" required><?php echo $results[0]["address"] ?></textarea> </div> </br> <input class="knob knob-data" type="submit" style="background-color:#ff7a59;" value="Submit" /> <input type="reset" class="knob knob-data" style="background-color:#3A5580;" value="Reset" /> </form> </div> </div> </div> </body> <script> $("form").submit(function(e) { var ref = $(this).find("[required]"); $(ref).each(function() { if ($(this).val() == '') { alert("Please fill out this field"); $(this).focus(); e.preventDefault(); return false; } }); return true; }); </script></div> </div></div></div></div></div>

</br> <center> <img src="../img/rsb.png" alt="myw3schools.com" > </center></br> </br></br> </div><div class="property-content-divider"></div></div></div><div class="clear"></div><div class="clear"></div><div id="page-footer" style="font-size:12px;background-color:#f1f1f1;"> <div id="footer" class="bag_24 footer-head"> <div itemtype="http://schema.org/WPFooter" itemscope="itemscope"> <div id="footer-content" class="grid_20"> <div> <div class="suggareas"> <p style="text-indent:10px;text-align: justify;-moz-text-align-last: right; text-align-last: left;"> </p> </div> <div class="clear"></div> <div style="font-size:12px;color:gray;text-align:center"> Copyright &#169; 2018 myw3schools. All rights reserved. </div> </div> </div> <div class="tail-to-head"> <a class="pointer" href="#top" style="text-decoration:none"> <font color="gray"> <i class="fa fa-arrow-up" aria-hidden="true"></i> Back to Top</font> </a> </div> </div> </div></div><script type='text/javascript' src='../js/output.min1.js'></script><script> $(window).bind("pageshow", function(event) { if (event.originalEvent.persisted) { window.location.reload() } });</script><script src="../js/gtag.js?id=UA-131555544-1"></script><script> window.dataLayer = window.dataLayer || []; function gtag() { dataLayer.push(arguments); } gtag('js', new Date()); gtag('config', 'UA-131555544-1');</script></body></html>