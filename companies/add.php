...
$query = "INSERT INTO companies_info SET name=?, phone=?, email=?, website=?";
...
<title>Add Companies | MyW3schools.com 
</title> 
...
<input type="text" class="form-control" id="email21" name="name" placeholder="Company Name *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" required> 
</div> 

<div class="form-field"> 
<input type="text" class="form-control" id="email22" name="phone" placeholder="Phone Number *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" required> 
</div> 

<div class="form-field"> 
<input type="text" class="form-control" id="email23" name="email" placeholder="Email *" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" required> 
</div> 

<div class="form-field"> 
<input type="url" class="form-control" id="email24" name="website" placeholder=" Website URL *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" required> 
</div> </br> 
...
</div></br> <center> <img src="../img/rsb.png" alt="myw3schools.com" > </center></br> </br></br> 
</div> 
</div> 
</div>
<div class="property-content-divider">
