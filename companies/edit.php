...
if(isset($_POST['submit_btn'])) {
        ...
        $query = "UPDATE companies_info SET name=?, phone=?, email=?, website=?  WHERE id=?";
        ...
        $stmt->bindParam(4, $_POST['website']);
...
$query = "SELECT * FROM companies_info WHERE id=?";
...
<title>Edit Companies | MyW3schools.com | Download Fiction, Health, Romance and many more ebooks for Free: any where, anytime!
</title> 
...
<input type="text" class="form-control" id="email21" name="name" value="<?php echo $name; ?>" placeholder="Company Name *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="color:#999;" required> 
</div> 

<div class="form-field"> 
<input type="text" class="form-control" id="email22" name="phone" value="<?php echo $phone; ?>" placeholder="Phone Number *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="color:#999;" required> 
</div> 

<div class="form-field"> 
<input type="email" class="form-control" id="email23" name="email" value="<?php echo $email; ?>" placeholder="Email *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="color:#999;" required> 
</div> 

<div class="form-field"> 
<input type="text" class="form-control" id="email24" name="website" value="<?php echo $website; ?>" placeholder=" Website URL For Example : www.example.com *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="color:#999;" required> 
</div> </br> 
