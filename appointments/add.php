...
$query = "INSERT INTO appointment_details SET contact_person=?, subject=?, appointment_date=?, appointment_time=?, status=? , location=?,created_at='$date'";
...
<title>Add Appointments | MyW3schools.com | Download Fiction, Health, Romance and many more ebooks for Free: any where, anytime!
</title> 
...
<input type="text" class="form-control" id="email21" name="contact_person" placeholder="Contact Person *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" required> 
</div> 

<div class="form-field"> 
<input type="text" class="form-control" id="email22" name="subject" placeholder="Subject *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" required> 
</div> 

<div class="form-field"> 
<input type="date" class="form-control" id="email23" name="appointment_date" placeholder="Date *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="color:#999;" required> 
</div> 

<div class="form-field"> 
<select type="text" class="form-control" id="email24" name="appointment_time" style="color:#999;"> 
...
<div class="form-field"> 
<select type="text" class="form-control" id="email25" name="location" style="color:#999;"> 
