...
if(isset($_POST['submit_btn'])) {
        ...
        $query = "UPDATE leads_details SET name=?, fresher_working_professional=?, course=?, phone=?, email=? , status=? WHERE id=?";

        $stmt = $dbc->prepare($query);

        $stmt->bindParam(1, $_POST['name']);

        $stmt->bindParam(2, $_POST['fresher_working_professional']);

		 $stmt->bindParam(3, $_POST['course']);
...
$query = "SELECT * FROM leads_details WHERE id=?";
...
$fresher_working_professional = $row['fresher_working_professional'];
...
<title>Edit Leads | MyW3schools.com | Download Fiction, Health, Romance and many more ebooks for Free: any where, anytime!
</title> 
...
<input type="text" class="form-control" id="email21" name="name" value="<?php echo $name; ?>" placeholder="Name *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="color:#999;" required> 
</div> </br> 

<div class="panel panel-default"> 

<div class="panel-heading" id="item-12" role="tab" style="background-color:#eef1f4;"> <h5 class="panel-title" style="text-align: left;font-size:12px;"><a aria-controls="content-item-12" aria-expanded="true" data-parent="#accordion-1" data-toggle="collapse" href="#content-item-12" role="button"> <?php echo $fresher_working_professional; ?> </a></h5>
</div> 
...
<select class="form-control" id="email22" name="fresher_working_professional" value="<?php echo $fresher_working_professional; ?>" style="color:#999;" required> 

<option value="Selected None">Please select F / WP *</option> 
...
<div class="form-field"> 
<input type="text" class="form-control" id="email23" name="course" value="<?php echo $course; ?>" placeholder="Course *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="color:#999;" required> 
</div> 

<div class="form-field"> 
<input type="text" class="form-control" id="email24" name="phone" value="<?php echo $phone; ?>" placeholder="Phone Number *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="color:#999;" required> 
</div> 

<div class="form-field"> 
<input type="email" class="form-control" id="email25" value="<?php echo $email; ?>" name="email" placeholder="Email *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="color:#999;" required> 
</div> </br> 
...
<div class="panel-body" style="background-color:#eef1f4;"> 
<select class="form-control" id="email26" name="status" value="<?php echo $status; ?>" style="color:#999;" required> 
