...
$query = "INSERT INTO leads_details SET name=?, fresher_working_professional=?, course=?, phone=?, email=? , created_date=?, status=?";
...
$stmt->bindParam(6, date('m/d/Y'));

$stmt->bindParam(7, $_POST['status']);
...
<title>Create Leads | MyW3schools.com | Download Fiction, Health, Romance and many more ebooks for Free: any where, anytime!
</title> 
...
<input type="text" class="form-control" id="email21" name="name" placeholder="Name *" autocomplete="off" required> 
</div> 

<div class="form-field"> 
<select type="text" class="form-control" id="email22" name="fresher_working_professional" style="color:#999;"> 
...
<div class="form-field"> 
<input type="text" class="form-control" id="email23" name="course" placeholder="Course *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" required> 
</div> 

<div class="form-field"> 
<input type="text" class="form-control" id="email24" name="phone" placeholder="Phone Number *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" required> 
</div> 

<div class="form-field"> 
<input type="text" class="form-control" id="email25" name="email" placeholder="Email * " pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" required> 
</div> 

<div class="form-field"> 
<select type="text" class="form-control" id="email26" name="status" style="color:#999;"> 
