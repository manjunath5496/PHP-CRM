...
if(isset($_POST['submit_btn'])) {
        ...
        $query = "UPDATE tbl_info SET name=?, description=?, deadline=?, status=?  WHERE id=?";
...
$query = "SELECT * FROM tbl_info WHERE id=?";
...
<title>Edit Tasks | MyW3schools.com | Download Fiction, Health, Romance and many more ebooks for Free: any where, anytime!
</title> 
...
<input type="text" class="form-control" id="email21" name="name" value="<?php echo $name; ?>" placeholder="Task Name *" autocomplete="off" style="color:#999;" autocorrect="off" autocapitalize="off" spellcheck="false" required> 
</div> 
...
<div class="form-field"> 
<input type="date" class="form-control" id="email23" name="deadline" value="<?php echo $deadline; ?>" placeholder="Task Deadline *" autocomplete="off" style="color:#999;" autocorrect="off" autocapitalize="off" spellcheck="false" required> 
</div> </br> 
