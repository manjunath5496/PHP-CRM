...
$date = date('d/m/Y');
try {
$query = "INSERT INTO tbl_info SET name=?, description=?, deadline=?, status=? , created_at='$date'";
...
<title>Add Tasks | MyW3schools.com | Download Fiction, Health, Romance and many more ebooks for Free: any where, anytime!
</title> 
...
<input type="text" class="form-control" id="email21" name="name" placeholder="Task Name *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" required> 
</div> 
...
<div class="form-field"> 
<input type="date" class="form-control" id="email23" name="deadline" placeholder="Task Deadline *" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" style="color:#999;" required> 
</div> 
